...
export const Route = createFileRoute("/cookies")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "How Verdian uses cookies and similar technologies on our website." },
    ],
  }),
  component: () => (
    <LegalPage title="Cookie Policy" updated="July 1, 2026">
      <p>
        This Cookie Policy explains how Verdian Digital, Inc. (&ldquo;Verdian&rdquo;, &ldquo;we&rdquo;,
        &ldquo;us&rdquo;) uses cookies and similar technologies when you visit verdian.io and related
        pages.
      </p>
      ...
      <ul className="list-disc pl-6 space-y-2">
        <li>
          <strong>Essential cookies</strong> — required for core site functionality such as navigation
      ...
      <p>
        ...
        cookies. Blocking essential cookies may affect site functionality. Where required, we will ask
        for consent before setting non-essential cookies.
      </p>
      <h2>Updates</h2>
      <p>
        We may update this policy as our site or regulations change. Material changes will be reflected
