...
export const Route = createFileRoute("/terms")({
  head: () =>
    pageSeo({
      title: pageTitle("Terms of Service", "Zorqiva"),
      description: "Terms governing use of the Zorqiva website and services.",
      path: "/terms",
    }),
  component: () => (
    <LegalPage title="Terms of Service" updated="July 1, 2026">
      <p>
        ...
        Zorqiva&apos;s website and professional services. By engaging Zorqiva, you agree to these
        Terms.
      </p>
      <h2>Service description</h2>
      <p>
        Zorqiva provides IT consulting and software development services including custom
      ...
      <p>
        You may not misuse our services, attempt unauthorized access to our systems, or use Zorqiva
      ...
      <p>
        ...
        project upon full payment. Zorqiva retains rights to pre-existing tools, frameworks, and
        methodologies. Zorqiva branding and website content remain our property.
      </p>
      <h2>Limitation of liability</h2>
      <p>
        To the maximum extent permitted by law, Zorqiva&apos;s liability is limited to the fees
